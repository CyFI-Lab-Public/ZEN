...
class Python_3_7_13_IntermedSymbols(intermed.IntermediateSymbolTable):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.set_type_class("PyCodeObject", PyCodeObject)            # https://github.com/python/cpython/blob/v3.10.6/Include/cpython/code.h#L18
...
class PyCodeObject(objects.StructType):
    def get_value(self):
        ...
        co_posonlyargcount_FAKE_ARG = co_argcount - co_argcount
